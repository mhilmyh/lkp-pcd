...
In this example, we will see how to segment objects from a background. We use the ``coins`` image from ``skimage.data``,
which shows several coins outlined against a darker background.
"""
...
plt.savefig('LKP7/histogram_gray.png')
######################################################################
# Thresholding
# ============
#
...
plt.tight_layout()
plt.savefig('LKP7/coins_threshold.png')
######################################################################
...
plt.savefig('LKP7/remove_small_obj.png')
######################################################################
...
plt.savefig('LKP7/elevation_map.png')
######################################################################
...
plt.savefig('LKP7/segmentation.png')
######################################################################
